...
void APartyCharacterPlacementHelper_C::OnHotfixApplied()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PartyCharacterPlacementHelper_C", "OnHotfixApplied");
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FFortTeamMemberInfo&       Team_Info                                              (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
void APartyCharacterPlacementHelper_C::OnPartySuggestionAdded(int32 SlotIndex, struct FFortPartySuggestion& FortPartySuggestion)
{
	static class UFunction* Func = nullptr;
...
void APartyCharacterPlacementHelper_C::OnPartySuggestionUpdated(int32 SlotIndex, struct FFortPartySuggestion& FortPartySuggestion)
{
	static class UFunction* Func = nullptr;
...
void APartyCharacterPlacementHelper_C::OnPartySuggestionRemoved(int32 SlotIndex)
{
	static class UFunction* Func = nullptr;
...
void APartyCharacterPlacementHelper_C::OnPartySuggestionChanged(int32 SlotIndex, struct FFortPartySuggestion& FortPartySuggestion)
{
	static class UFunction* Func = nullptr;
...
void APartyCharacterPlacementHelper_C::OnPartySuggestionAccept(int32 PlayerID_0)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PartyCharacterPlacementHelper_C", "OnPartySuggestionAccept");
