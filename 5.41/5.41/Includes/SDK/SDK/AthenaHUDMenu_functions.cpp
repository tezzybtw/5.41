...
void UAthenaHUDMenu_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent)
{
	...
	Params::AthenaHUDMenu_C_OnAddedToFocusPath Parms{};
...
void UAthenaHUDMenu_C::OnPlayerLost(EEndOfMatchReason LostReason)
{
	...
	Params::AthenaHUDMenu_C_OnPlayerLost Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UAthenaPlayerViewModel*           ViewModel_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaHUDMenu_C::SetViewModel(class UAthenaPlayerViewModel* ViewModel_0)
{
	static class UFunction* Func = nullptr;
...
void UAthenaHUDMenu_C::Has_Player_Or_Team_Won(bool* bWon)
{
	...
	Params::AthenaHUDMenu_C_Has_Player_Or_Team_Won Parms{};
...
void UAthenaHUDMenu_C::Has_Player_Died(bool* bDied, struct FFortPlayerDeathReport* DeathReport)
{
	...
	Params::AthenaHUDMenu_C_Has_Player_Died Parms{};
