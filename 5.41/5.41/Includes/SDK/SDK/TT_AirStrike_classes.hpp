...
class UTT_AirStrike_C final : public UFortGameplayAbilityTooltip
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"TT_AirStrike_C">();
	}
	static class UTT_AirStrike_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTT_AirStrike_C>();
	}
};
