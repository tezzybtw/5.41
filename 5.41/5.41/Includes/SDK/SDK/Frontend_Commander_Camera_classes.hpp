...
class AFrontend_Commander_Camera_C final : public AFortCameraBase
{
public:
...
public:
	void ExecuteUbergraph_Frontend_Commander_Camera(int32 EntryPoint);
	void OnActivated();
	void OnDeactivated();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Frontend_Commander_Camera_C">();
	}
	static class AFrontend_Commander_Camera_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AFrontend_Commander_Camera_C>();
	}
};
