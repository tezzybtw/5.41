...
public:
	...
	uint8                                         Pad_1D8[0xA0];                                     // 0x01D8(0x00A0)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_C[0xC];                                        // 0x000C(0x000C)(Fixing Size After Last Property [ Dumper-8 ])
	...
	bool                                          bIsInhibited;                                      // 0x02D4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D5[0x9B];                                     // 0x02D5(0x009B)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_48[0x4];                                       // 0x0048(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_0[0x1C0];                                      // 0x0000(0x01C0)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_F0[0x310];                                     // 0x00F0(0x0310)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UGameplayEffect*>                ApplicationImmunityQueryEffects;                   // 0x0400(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_410[0x18];                                     // 0x0410(0x0018)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	struct FSoftObjectPath                        GameplayCueNotifyObj;                              // 0x0008(0x0018)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FCustomCalculationBasedFloat           CustomMagnitude;                                   // 0x0128(0x0090)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FSetByCallerFloat                      SetByCallerMagnitude;                              // 0x01B8(0x0010)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
};
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0050(0x01C8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x0218(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_219[0x7];                                      // 0x0219(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0220(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0260(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0030(0x01C8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector                                WorldOrigin;                                       // 0x0060(0x000C)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
