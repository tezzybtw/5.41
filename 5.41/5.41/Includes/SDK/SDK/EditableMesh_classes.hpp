...
{
public:
	uint8                                         Pad_28[0xD50];                                     // 0x0028(0x0D50)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UEditableMeshAdapter*>           Adapters;                                          // 0x0D78(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         TextureCoordinateCount;                            // 0x0D88(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8C[0xF8];                                     // 0x0D8C(0x00F8)(Fixing Size After Last Property [ Dumper-8 ])
	int32                                         PendingCompactCounter;                             // 0x0E84(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SubdivisionCount;                                  // 0x0E88(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E8C[0x1E4];                                    // 0x0E8C(0x01E4)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	void CreateMissingPolygonHoleEdges(const struct FPolygonID& PolygonID, const int32 HoleNumber, TArray<struct FEdgeID>* OutNewEdgeIDs);
	...
	void InsertPolygonPerimeterVertices(const struct FPolygonID& PolygonID, const int32 InsertBeforeVertexNumber, const TArray<struct FVertexAndAttributes>& VerticesToInsert);
	...
	void RemovePolygonPerimeterVertices(const struct FPolygonID& PolygonID, const int32 FirstVertexNumberToRemove, const int32 NumVerticesToRemove, const bool bDeleteOrphanedVertexInstances);
	void Revert();
	...
	void SetEdgesVertices(const TArray<struct FVerticesForEdge>& VerticesForEdges);
	...
	bool ComputeBarycentricWeightForPointOnPolygon(const struct FPolygonID& PolygonID, const struct FVector& PointOnPolygon, struct FMeshTriangle* OutTriangle, struct FVector* OutTriangleVertexWeights) const;
	...
	void ComputePolygonTriangulation(const struct FPolygonID& PolygonID, TArray<struct FMeshTriangle>* OutTriangles) const;
	int32 FindPolygonHoleEdgeNumberForVertices(const struct FPolygonID& PolygonID, const int32 HoleNumber, const struct FVertexID& EdgeVertexID0, const struct FVertexID& EdgeVertexID1) const;
	int32 FindPolygonHoleVertexNumberForVertex(const struct FPolygonID& PolygonID, const int32 HoleNumber, const struct FVertexID& VertexID) const;
	...
	int32 GetPolygonHoleCount(const struct FPolygonID& PolygonID) const;
	struct FEdgeID GetPolygonHoleEdge(const struct FPolygonID& PolygonID, const int32 HoleNumber, const int32 HoleEdgeNumber) const;
	int32 GetPolygonHoleEdgeCount(const struct FPolygonID& PolygonID, const int32 HoleNumber) const;
	void GetPolygonHoleEdges(const struct FPolygonID& PolygonID, const int32 HoleNumber, TArray<struct FEdgeID>* OutHoleEdgeIDs) const;
	struct FVertexID GetPolygonHoleVertex(const struct FPolygonID& PolygonID, const int32 HoleNumber, const int32 PolygonVertexNumber) const;
	int32 GetPolygonHoleVertexCount(const struct FPolygonID& PolygonID, const int32 HoleNumber) const;
	struct FVertexInstanceID GetPolygonHoleVertexInstance(const struct FPolygonID& PolygonID, const int32 HoleNumber, const int32 PolygonVertexNumber) const;
	void GetPolygonHoleVertexInstances(const struct FPolygonID& PolygonID, const int32 HoleNumber, TArray<struct FVertexInstanceID>* OutHoleVertexInstanceIDs) const;
	void GetPolygonHoleVertices(const struct FPolygonID& PolygonID, const int32 HoleNumber, TArray<struct FVertexID>* OutHoleVertexIDs) const;
	...
	struct FMeshTriangle GetPolygonTriangulatedTriangle(const struct FPolygonID& PolygonID, int32 PolygonTriangleNumber) const;
...
public:
	...
	uint8                                         Pad_3C[0xA4];                                      // 0x003C(0x00A4)(Fixing Struct Size After Last Property [ Dumper-8 ])
