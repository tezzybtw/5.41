...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   RiftLocationWS                                         (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const struct FVector&                   Vector_Value                                           (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AEnemyPawn_Parent_C::SetVectorParameterOnAllCharacterMIDs(class FName Parameter_Name, const struct FVector& Vector_Value)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   Hit_Direction                                          (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TMap<class FName, struct FLinearColor>&Map                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TMap<class FName, float>&         Map                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
...
// const TArray<class UMaterialInstanceDynamic*>&Array_to_Store                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
