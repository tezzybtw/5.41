...
void AGCN_BluGloPylon_Energy_Activate_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_BluGloPylon_Energy_Activate_C", "UserConstructionScript");
...
void AGCN_BluGloPylon_Energy_Activate_C::OnStartParticleSystemSpawned(class UParticleSystemComponent* SpawnedParticleSysComponent, const struct FGameplayCueParameters& Parameters) const
{
	static class UFunction* Func = nullptr;
