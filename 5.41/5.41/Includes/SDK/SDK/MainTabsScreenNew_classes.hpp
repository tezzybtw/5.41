...
class UMainTabsScreenNew_C final : public UFortMainTabsScreenBase
{
public:
...
public:
	void ExecuteUbergraph_MainTabsScreenNew(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MainTabsScreenNew_C">();
	}
	static class UMainTabsScreenNew_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMainTabsScreenNew_C>();
	}
};
