...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05425940;
	constexpr int32 AppendString      = 0x0167EA30;
	constexpr int32 GNames            = 0x05420C50;
	constexpr int32 GWorld            = 0x055257A0;
	constexpr int32 ProcessEvent      = 0x0182D530;
	constexpr int32 ProcessEventIdx   = 0x00000040;
    constexpr int32 Free              = 0x02B22BD0;
    constexpr int32 Realloc           = 0x015C7020;
}
...
public:
	...
	static constexpr int32                        ElementsPerChunk = 0x10400;                        // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
