...
#include "Athena_PartySuggestion_TempFix_classes.hpp"
#include "Athena_PartySuggestion_TempFix_parameters.hpp"
...
void UAthena_PartySuggestion_TempFix_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_PreConstruct Parms{};
...
void UAthena_PartySuggestion_TempFix_C::NewPartySuggestion(const struct FFortPartySuggestion& Party_Suggestion_Struct)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_NewPartySuggestion Parms{};
...
void UAthena_PartySuggestion_TempFix_C::UpdatePartySuggestion(const struct FFortPartySuggestion& PartySuggestionStruct)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_UpdatePartySuggestion Parms{};
...
void UAthena_PartySuggestion_TempFix_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_Tick Parms{};
...
void UAthena_PartySuggestion_TempFix_C::BndEvt__IconTextButton_K2Node_ComponentBoundEvent_31_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_31_CommonButtonClicked__DelegateSignature Parms{};
...
struct FEventReply UAthena_PartySuggestion_TempFix_C::OnMouseButtonDown_0(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
	...
	Params::Athena_PartySuggestion_TempFix_C_OnMouseButtonDown_0 Parms{};
...
void UAthena_PartySuggestion_TempFix_C::InitNewPartySuggestion(const struct FFortPartySuggestion& NewPartySuggestion)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_InitNewPartySuggestion Parms{};
...
void UAthena_PartySuggestion_TempFix_C::InitPhysAnim()
{
	static class UFunction* Func = nullptr;
...
void UAthena_PartySuggestion_TempFix_C::SetMainMIDs(class UMaterialInstanceDynamic* BorderMID, class UMaterialInstanceDynamic* TailMID, class UMaterialInstanceDynamic* SparklesMID)
{
	static class UFunction* Func = nullptr;
	...
	Params::Athena_PartySuggestion_TempFix_C_SetMainMIDs Parms{};
...
void UAthena_PartySuggestion_TempFix_C::SetupMIDReferences()
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FLinearColor&              NewColor                                               (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthena_PartySuggestion_TempFix_C::TempFix_TintMainBrushes(const struct FLinearColor& NewColor)
{
	...
	Params::Athena_PartySuggestion_TempFix_C_TempFix_TintMainBrushes Parms{};
