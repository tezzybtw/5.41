...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue;          // 0x0240(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Get_Location_in_Circle_XY_LocationLocalSpace; // 0x024C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_CustomEvent_Location;                       // 0x0258(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue1;         // 0x027C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
