...
void APlayerPawn_Generic_C::ReinitializeWeaponMaterialArray()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Generic_C", "ReinitializeWeaponMaterialArray");
...
void APlayerPawn_Generic_C::GameplayCue_Abilities_Death_FadeCapsule_StW(EGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Generic_C", "GameplayCue.Abilities.Death.FadeCapsule_StW");

	Params::PlayerPawn_Generic_C_GameplayCue_Abilities_Death_FadeCapsule_StW Parms{};
...
// Parameters:
// class UMaterialInterface*               Material_to_Apply                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Quick_Parameters                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void APlayerPawn_Generic_C::Override_Materials_and_Copy_Parameters_on_Character_Mesh(class UMaterialInterface* Material_to_Apply, bool Quick_Parameters)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Generic_C", "Override Materials and Copy Parameters on Character Mesh");

	Params::PlayerPawn_Generic_C_Override_Materials_and_Copy_Parameters_on_Character_Mesh Parms{};

	Parms.Material_to_Apply = Material_to_Apply;
	Parms.Quick_Parameters = Quick_Parameters;
...
void APlayerPawn_Generic_C::Create_Duplicate_Character_Mesh(class UMaterialInterface* Material_to_Apply, bool Quick_Parameters)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Generic_C", "Create Duplicate Character Mesh");

	Params::PlayerPawn_Generic_C_Create_Duplicate_Character_Mesh Parms{};
...
void APlayerPawn_Generic_C::Delete_Duplicate_Character_Mesh()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Generic_C", "Delete Duplicate Character Mesh");
