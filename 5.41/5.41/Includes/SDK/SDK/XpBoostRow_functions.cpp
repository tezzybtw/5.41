...
void UXpBoostRow_C::OnPlayerInfoChanged(const struct FFortTeamMemberInfo& NewInfo)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("XpBoostRow_C", "OnPlayerInfoChanged");

	Params::XpBoostRow_C_OnPlayerInfoChanged Parms{};
...
// const struct FFortTeamMemberInfo&       Party_Members_Info                                     (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
void UXpBoostRow_C::Update_Boost_Amount()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("XpBoostRow_C", "Update Boost Amount");
