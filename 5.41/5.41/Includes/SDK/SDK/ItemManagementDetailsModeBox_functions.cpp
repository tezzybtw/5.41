...
void UItemManagementDetailsModeBox_C::HandleQuickbarContentsChanged(EFortQuickBars QuickbarIndex, TArray<int32>& ChangedSlots)
{
	static class UFunction* Func = nullptr;
...
void UItemManagementDetailsModeBox_C::RegisterOpenCustomFilter()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "RegisterOpenCustomFilter");
...
void UItemManagementDetailsModeBox_C::HandleOpenCustomFilter(bool* Passthrough)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "HandleOpenCustomFilter");

	Params::ItemManagementDetailsModeBox_C_HandleOpenCustomFilter Parms{};
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// ESlateVisibility*                       StatsTabVisbility                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UItemManagementDetailsModeBox_C::GetStatsTabVisibility(ESlateVisibility* StatsTabVisbility)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "GetStatsTabVisibility");

	Params::ItemManagementDetailsModeBox_C_GetStatsTabVisibility Parms{};
