...
void UQuickbarBase_C::OnQuickbarContentsChanged(EFortQuickBars QuickbarIndex, const TArray<int32>& ChangedSlots)
{
	static class UFunction* Func = nullptr;
...
void UQuickbarBase_C::HandleQuickbarContentChanged(EFortQuickBars QuickBarType, TArray<int32>& ChangedSlots)
{
	static class UFunction* Func = nullptr;
	...
	Params::QuickbarBase_C_HandleQuickbarContentChanged Parms{};
	...
	ChangedSlots = std::move(Parms.ChangedSlots);
}
