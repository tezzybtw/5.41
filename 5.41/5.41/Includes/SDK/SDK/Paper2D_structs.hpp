...
public:
	...
	uint8                                         Pad_18[0x30];                                      // 0x0018(0x0030)(Fixing Size After Last Property [ Dumper-8 ])
	struct FColor                                 Color;                                             // 0x0048(0x0004)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x84];                                      // 0x004C(0x0084)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
