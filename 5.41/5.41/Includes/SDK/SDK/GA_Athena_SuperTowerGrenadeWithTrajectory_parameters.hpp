...
public:
	...
	struct FVector                                K2Node_Event_Location;                             // 0x000C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               K2Node_Event_Direction;                            // 0x0018(0x000C)(IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_SpawnLocationAndRotation_OutLoc;          // 0x0050(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_SpawnLocationAndRotation_OutRot;          // 0x005C(0x000C)(IsPlainOldData, NoDestructor)
