...
// const struct FVector&                   HitVelocity                                            (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor*                           HitActor                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void APhysicsBall_Master_C::ReplicateKick(const struct FVector& HitLocation, const struct FVector& HitVelocity, class AActor* HitActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PhysicsBall_Master_C", "ReplicateKick");

	Params::PhysicsBall_Master_C_ReplicateKick Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   NewVelocity                                            (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
