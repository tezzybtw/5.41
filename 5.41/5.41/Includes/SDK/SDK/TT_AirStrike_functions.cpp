...
#include "TT_AirStrike_classes.hpp"
#include "TT_AirStrike_parameters.hpp"
...
void UTT_AirStrike_C::InitializeAbilityInstanceInternal(const class UGameplayAbility* AbilityInstance, const class UFortTooltipContext* Context) const
{
	...
	Params::TT_AirStrike_C_InitializeAbilityInstanceInternal Parms{};
...
bool UTT_AirStrike_C::GetApplicationTag(const class UGameplayAbility* AbilityInstance, struct FGameplayTag* OutTag) const
{
	static class UFunction* Func = nullptr;
	...
	Params::TT_AirStrike_C_GetApplicationTag Parms{};
...
bool UTT_AirStrike_C::GetTextForTokenFromAbilityInstanceInternal(const class UGameplayAbility* AbilityInstance, const struct FGameplayTag& Tag, const class UFortTooltipContext* Context, const struct FGameplayTag& Token, class FText* OutText) const
{
	static class UFunction* Func = nullptr;
	...
	Params::TT_AirStrike_C_GetTextForTokenFromAbilityInstanceInternal Parms{};
