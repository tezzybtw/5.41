...
void UT2_Horde_C::ExecuteUbergraph_T2_Horde(int32 EntryPoint)
{
	...
	Params::T2_Horde_C_ExecuteUbergraph_T2_Horde Parms{};
...
void UT2_Horde_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::T2_Horde_C_PreConstruct Parms{};
