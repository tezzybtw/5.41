...
public:
	...
	struct FRotator                               CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x00F0(0x000C)(IsPlainOldData, NoDestructor)
	...
	struct FRotator                               CallFunc_MakeRotator_ReturnValue;                  // 0x0120(0x000C)(IsPlainOldData, NoDestructor)
	...
	struct FRotator                               K2Node_CustomEvent_LaunchRotation;                 // 0x0168(0x000C)(IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_TransformDirection_ReturnValue;           // 0x01B0(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle       K2Node_CustomEvent_TargetData1;                    // 0x02C8(0x0020)(ConstParm)
	struct FGameplayTag                           K2Node_CustomEvent_ApplicationTag1;                // 0x02E8(0x0008)(NoDestructor, HasGetValueTypeHash)
	TArray<struct FActiveGameplayEffectHandle>    CallFunc_ApplyGameplayEffectContainer_ReturnValue; // 0x02F0(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
};
