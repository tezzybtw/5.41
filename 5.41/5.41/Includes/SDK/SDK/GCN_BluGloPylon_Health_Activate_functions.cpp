...
#include "GCN_BluGloPylon_Health_Activate_classes.hpp"
...
void AGCN_BluGloPylon_Health_Activate_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_BluGloPylon_Health_Activate_C", "UserConstructionScript");
...
void AGCN_BluGloPylon_Health_Activate_C::OnStartParticleSystemSpawned(class UParticleSystemComponent* SpawnedParticleSysComponent, const struct FGameplayCueParameters& Parameters) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCN_BluGloPylon_Health_Activate_C", "OnStartParticleSystemSpawned");

	Params::GCN_BluGloPylon_Health_Activate_C_OnStartParticleSystemSpawned Parms{};
