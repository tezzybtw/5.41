...
bool AGC_NPC_Elemental_Fire_C::WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_NPC_Elemental_Fire_C", "WhileActive");

	Params::GC_NPC_Elemental_Fire_C_WhileActive Parms{};
