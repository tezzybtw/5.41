...
public:
	...
	struct FVector                                CallFunc_GetComponentBounds_Origin;                // 0x002C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetComponentBounds_BoxExtent;             // 0x0038(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_Conv_FloatToVector_ReturnValue;           // 0x004C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue;     // 0x00A8(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
