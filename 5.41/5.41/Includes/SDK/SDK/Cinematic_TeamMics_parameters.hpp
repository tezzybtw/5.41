...
public:
	...
	bool                                          Temp_bool_Variable2;                               // 0x0224(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	int32                                         K2Node_Select1_Default;                            // 0x023C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsNetIdFromLocalPlayersPlatform_ReturnValue; // 0x0240(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_241[0x7];                                      // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	struct FUniqueNetIdRepl                       K2Node_Select2_Default;                            // 0x0248(0x0028)(ConstParm, HasGetValueTypeHash)
};
