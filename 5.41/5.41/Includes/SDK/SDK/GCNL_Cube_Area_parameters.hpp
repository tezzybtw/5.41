...
public:
	...
	struct FVector                                K2Node_CustomEvent_Location;                       // 0x0214(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_CustomEvent_Velocity;                       // 0x0220(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct alignas(0x08) GCNL_Cube_Area_C_On_Shield_Squares_Spawn final
{
public:
