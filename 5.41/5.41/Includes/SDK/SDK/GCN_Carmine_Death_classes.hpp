...
class UGCN_Carmine_Death_C final : public UFortGameplayCueNotify_Simple
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Carmine_Death_C">();
	}
	static class UGCN_Carmine_Death_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Carmine_Death_C>();
	}
};
