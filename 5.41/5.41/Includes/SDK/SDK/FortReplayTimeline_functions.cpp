...
void UFortReplayTimeline_C::ClearTimelineMarkers()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortReplayTimeline_C", "ClearTimelineMarkers");
...
void UFortReplayTimeline_C::Destruct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortReplayTimeline_C", "Destruct");
...
void UFortReplayTimeline_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortReplayTimeline_C", "Construct");
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortReplayEventType                    EventType                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UFortReplayTimeline_C::AddMarkerToTimeline(EFortReplayEventType EventType, float RelativeTime, int32 EventIdx)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortReplayTimeline_C", "AddMarkerToTimeline");

	Params::FortReplayTimeline_C_AddMarkerToTimeline Parms{};
