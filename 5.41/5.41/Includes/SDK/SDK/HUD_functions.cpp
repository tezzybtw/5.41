...
void UHUD_C::ShowPersonalVehicleMounting()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "ShowPersonalVehicleMounting");
...
void UHUD_C::InputActionHoldStopped(class FName InputActionName, bool bCompletedSuccessfully)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "InputActionHoldStopped");

	Params::HUD_C_InputActionHoldStopped Parms{};
...
void UHUD_C::InputActionHoldStarted(class FName InputActionName, float Duration)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "InputActionHoldStarted");

	Params::HUD_C_InputActionHoldStarted Parms{};
...
void UHUD_C::PersonalVehicleModeChanged(bool bEnteredVehicle)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "PersonalVehicleModeChanged");

	Params::HUD_C_PersonalVehicleModeChanged Parms{};
...
// Parameters:
// const struct FEndOfDayRecap&            EndOfDayRecap                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
