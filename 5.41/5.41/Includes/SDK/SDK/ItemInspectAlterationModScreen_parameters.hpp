...
public:
	...
	class UAlterationOptionsWidget_C*             K2Node_DynamicCast_AsAlteration_Options_Widget;    // 0x0008(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UItemWindow_C*                          CallFunc_Create_ReturnValue;                       // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UFortItemDefinition*>            CallFunc_GetItemDefinitions_ReturnValue;           // 0x0038(0x0010)(ZeroConstructor, ReferenceParm)
	...
	bool                                          K2Node_Event_SelectedSlot;                         // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UFortAlterationOption*                  K2Node_Event_CurrentAlterationOption;              // 0x0060(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FFortItemQuantityPair>          CallFunc_GetRequiredIngredients_ReturnValue;       // 0x0068(0x0010)(ZeroConstructor, ReferenceParm)
};
