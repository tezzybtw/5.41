...
{
public:
	uint8                                         Pad_F0[0xC];                                       // 0x00F0(0x000C)(Fixing Size After Last Property [ Dumper-8 ])
	uint8                                         BitPad_FC_0 : 1;                                   // 0x00FC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-8 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x00FC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_FD[0x3];                                       // 0x00FD(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UGameplayTask*>                  SimulatedTasks;                                    // 0x0100(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  TaskPriorityQueue;                                 // 0x0110(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_120[0x10];                                     // 0x0120(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UGameplayTask*>                  TickingTasks;                                      // 0x0130(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  KnownTasks;                                        // 0x0140(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	UMulticastDelegateProperty_                   OnClaimedResourcesChange;                          // 0x0150(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_38[0x2];                                       // 0x0038(0x0002)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_3B[0x25];                                      // 0x003B(0x0025)(Fixing Size After Last Property [ Dumper-8 ])
