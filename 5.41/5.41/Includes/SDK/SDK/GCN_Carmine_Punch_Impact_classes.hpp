...
class UGCN_Carmine_Punch_Impact_C final : public UFortGameplayCueNotify_Simple
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Carmine_Punch_Impact_C">();
	}
	static class UGCN_Carmine_Punch_Impact_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Carmine_Punch_Impact_C>();
	}
};
