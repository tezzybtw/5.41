...
public:
	...
	uint8                                         Pad_342[0x6];                                      // 0x0342(0x0006)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_CB[0x15];                                      // 0x00CB(0x0015)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_3C5[0xB];                                      // 0x03C5(0x000B)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_3E4[0x14];                                     // 0x03E4(0x0014)(Fixing Size After Last Property [ Dumper-8 ])
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x03F8(0x0040)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_438[0x3A8];                                    // 0x0438(0x03A8)(Fixing Struct Size After Last Property [ Dumper-8 ])
