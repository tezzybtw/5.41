...
#include "TT_Constructor_BullRush_classes.hpp"
#include "TT_Constructor_BullRush_parameters.hpp"
...
void UTT_Constructor_BullRush_C::InitializeAbilityInstanceInternal(const class UGameplayAbility* AbilityInstance, const class UFortTooltipContext* Context) const
{
	...
	Params::TT_Constructor_BullRush_C_InitializeAbilityInstanceInternal Parms{};
...
bool UTT_Constructor_BullRush_C::GetTextForTokenFromAbilityInstanceInternal(const class UGameplayAbility* AbilityInstance, const struct FGameplayTag& Tag, const class UFortTooltipContext* Context, const struct FGameplayTag& Token, class FText* OutText) const
{
	static class UFunction* Func = nullptr;
	...
	Params::TT_Constructor_BullRush_C_GetTextForTokenFromAbilityInstanceInternal Parms{};
...
bool UTT_Constructor_BullRush_C::GetApplicationTag(const class UGameplayAbility* AbilityInstance, struct FGameplayTag* OutTag) const
{
	static class UFunction* Func = nullptr;
	...
	Params::TT_Constructor_BullRush_C_GetApplicationTag Parms{};
