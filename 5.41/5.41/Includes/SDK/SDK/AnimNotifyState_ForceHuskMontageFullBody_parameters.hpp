...
struct AnimNotifyState_ForceHuskMontageFullBody_C_Received_NotifyBegin final
{
public:
	...
	class UFortHuskAnimInstance*                  K2Node_DynamicCast_AsFort_Husk_Anim_Instance;      // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x0030 (0x0030 - 0x0000)
struct AnimNotifyState_ForceHuskMontageFullBody_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
