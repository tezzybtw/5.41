...
public:
	...
	void Focus();
	void GetAccountLevelUpReward(int32 AccountLevel, struct FSlateBrush* Icon, bool* ValidIcon, class UFortItemDefinition** ItemDef, int32* Quantity);
	void GetCurrentLevel(int32* CurrentLevel);
	void UpdateDisplayedReward();
