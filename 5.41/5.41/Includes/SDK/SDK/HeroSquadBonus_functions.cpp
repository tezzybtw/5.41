...
void UHeroSquadBonus_C::OnCombinedTooltipDescriptionReady(const class FText& Description)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HeroSquadBonus_C", "OnCombinedTooltipDescriptionReady");

	Params::HeroSquadBonus_C_OnCombinedTooltipDescriptionReady Parms{};
