...
// 0x0010 (0x0010 - 0x0000)
struct FPolygonHoleVertices final
{
public:
	TArray<struct FVertexAndAttributes>           HoleVertices;                                      // 0x0000(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FVector                                NewVertexPosition;                                 // 0x0004(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// ScriptStruct EditableMesh.VerticesForEdge
// 0x000C (0x000C - 0x0000)
struct FVerticesForEdge final
{
public:
...
public:
	...
	TArray<struct FPolygonHoleVertices>           PolygonHoles;                                      // 0x0018(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FPolygonID                             OriginalPolygonID;                                 // 0x0028(0x0004)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPolygonEdgeHardness                          PolygonEdgeHardness;                               // 0x002C(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector2D                              TextureCoordinate0;                                // 0x0004(0x0008)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              TextureCoordinate1;                                // 0x000C(0x0008)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FColor                                 VertexColor;                                       // 0x0014(0x0004)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VertexNormal;                                      // 0x0018(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VertexTangent;                                     // 0x0024(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_C[0x3C];                                       // 0x000C(0x003C)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
