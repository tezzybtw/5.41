...
// float                                   Activation_Radius_0                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_BGA_Athena_C4_C::SetExplosion(int32 Explosion_Level, float Activation_Radius_0, class AFortPlayerPawn* PlayerPawn)
{
	static class UFunction* Func = nullptr;
...
// float                                   Activation_Delay_0                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_BGA_Athena_C4_C::SetProjectile(float Init_Speed, float Gravity, float Activation_Delay_0)
{
	static class UFunction* Func = nullptr;
