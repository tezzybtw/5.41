...
{
public:
	class UImagePlateComponent*                   ImagePlate;                                        // 0x0328(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FImagePlateParameters                  Plate;                                             // 0x0560(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_598[0x98];                                     // 0x0598(0x0098)(Fixing Struct Size After Last Property [ Dumper-8 ])
