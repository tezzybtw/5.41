...
class UGCN_C_HitPlayer_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_C_HitPlayer_C">();
	}
	static class UGCN_C_HitPlayer_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_C_HitPlayer_C>();
	}
};
