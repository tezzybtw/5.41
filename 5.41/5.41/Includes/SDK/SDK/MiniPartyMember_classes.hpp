...
public:
	...
	struct FFortTeamMemberInfo                    MemberInfo;                                        // 0x02A0(0x01F8)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	class UFortUIManagerWidget_NUI*               UIManager;                                         // 0x0498(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPartyFinder_C*                         PartyFinder;                                       // 0x04A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
