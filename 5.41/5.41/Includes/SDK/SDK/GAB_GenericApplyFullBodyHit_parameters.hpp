...
public:
	...
	TDelegate<void(class AActor* SelfActor, class AActor* OtherActor, const struct FVector& NormalImpulse, const struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate2; // 0x01C0(0x0010)(ZeroConstructor, NoDestructor)
	...
	class AFortPawn*                              CallFunc_GetActivatingPawn_ReturnValue2;           // 0x0238(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate3;             // 0x0260(0x0010)(ZeroConstructor, NoDestructor)
	...
	class AFortPawn*                              CallFunc_GetActivatingPawn_ReturnValue4;           // 0x0290(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue2; // 0x0298(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue3; // 0x02A4(0x0008)(NoDestructor, HasGetValueTypeHash)
};
