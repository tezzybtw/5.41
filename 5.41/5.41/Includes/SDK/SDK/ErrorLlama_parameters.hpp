...
public:
	...
	struct FVector2D                              CallFunc_GetMousePositionOnPlatform_ReturnValue;   // 0x0098(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_GetLocalSize_ReturnValue;                 // 0x00A0(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_LocalToAbsolute_ReturnValue;              // 0x00B8(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_Subtract_Vector2DVector2D_ReturnValue;    // 0x00C0(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_Normal2D_ReturnValue;                     // 0x00C8(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(ECommonInputType bNewInputType)> K2Node_CreateDelegate_OutputDelegate;            // 0x0110(0x0010)(ZeroConstructor, NoDestructor)
	struct FVector2D                              K2Node_CustomEvent_2DInputVec;                     // 0x0120(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_Multiply_Vector2DFloat_ReturnValue1;      // 0x0144(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_RotateAngleAxis_ReturnValue;              // 0x014C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue1;                // 0x0164(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_Vector2DInterpTo_ReturnValue;             // 0x016C(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	struct FVector2D                              TwoDInputVec;                                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
